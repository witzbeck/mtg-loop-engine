...
- M5 novel / absent candidates: [`M5_NOVEL_CANDIDATES.md`](M5_NOVEL_CANDIDATES.md) (rules-evidence rails → [`../RULES_EVIDENCE.md`](../RULES_EVIDENCE.md); opportunistic consistency hygiene → same file + `ROADMAP.md` §2b)
