...
19. **Frontier-driven slices (M5.2):** pick from live P0/P1; ritual below. Path **a** preference remains.
...
#### Current queue (remeasured post–slice 18)
...
Probe (post–slice 18): **65** COMPLETE · **60** verified · **54** in_reference · **6** absent. Keep `ABSENT_FROM_REFERENCE` (not `NOVEL`).
