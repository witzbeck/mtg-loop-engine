...
55. **Path b (Bond/Blood)** ✓ — generic life-gain seed; disclosed on witness.
56. **Path b′ (Mindcrank / Bloodchief)** ✓ — generic opponent life-loss seed (drain-sized); disclosed on witness.
